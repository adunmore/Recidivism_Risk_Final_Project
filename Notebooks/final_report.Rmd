...
author: 'π-lence of the Lambs: Aaron Dunmore (ID: adunmore) and Minseon Lee (ID: minseonl)'
output:
  html_document:
  toc: TRUE
  toc_float: TRUE
...
df <- read_csv("../Data/arrest_history.csv")
df_violent <- read_csv("../Data/arrest_history_violent.csv")
df_raw <- read_csv("../Data/arrest_history_raw.csv")
